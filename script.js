const questions = [
  ...
  "Que pergunta faria a alguém próximo sobre como está hoje, além de tudo bem?",
  "Como você nota que alguém próximo não está bem, mesmo sem dizer?",
  "Qual foi a última vez que você viu alguém triste e tentou ajudar? Como foi?",
  "Você percebe quando alguém esconde uma emoção? Como reage?",
  "Como podemos acolher a alegria de outra pessoa sem sentir inveja?",
  "Que atividade transforma seu dia ruim em melhor",
  "Como você pede ajuda quando está se sentindo vulnerável?",
  "O que diria ao seu eu de 5 anos se estivesse chorando?",
  ...
  "Quando foi a última vez que se orgulhou de uma atitude sua, não de uma conquista?",
  "Há algo comum para os outros que te causa desconforto?",
  ...
  "Você esconde fraquezas para parecer forte? E se parasse?",
  ...
  "Se pudesse nomear o monstro da sua ansiedade, qual seria?",
  ...
  "Há algum erro do passado que ainda pesa em você? O que seria necessário para se perdoar?",
  ...
  "Quando está muito feliz, o que faz ou com quem compartilha?",
  "O que te dá uma sensação de segurança quando o mundo lá fora parece caótico?",
  "Que emoção gostaria de sentir mais e como cultivá-la?",
